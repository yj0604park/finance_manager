...
export class AccountSnapshotsService {
   ...
   * @throws ApiError
   */
  public static accountSnapshotsRetrieve(id: number): CancelablePromise<AccountSnapshot> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static accountSnapshotsDestroy(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/account-snapshots/{id}/',
      path: {
