...
export class BanksService {
     ...
     * @throws ApiError
     */
    public static banksPartialUpdate(
        id: number,
        requestBody?: PatchedBank,
    ): CancelablePromise<Bank> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/banks/{id}/',
