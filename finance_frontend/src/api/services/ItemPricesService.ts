...
export class ItemPricesService {
   ...
   * @throws ApiError
   */
  public static itemPricesCreate(requestBody: ItemPrice): CancelablePromise<ItemPrice> {
    return __request(OpenAPI, {
      method: 'POST',
      url: '/api/item-prices/',
      body: requestBody,
   ...
   * @throws ApiError
   */
  public static itemPricesRetrieve(id: number): CancelablePromise<ItemPrice> {
    return __request(OpenAPI, {
      method: 'GET',
   ...
   * @throws ApiError
   */
  public static itemPricesUpdate(id: number, requestBody: ItemPrice): CancelablePromise<ItemPrice> {
    return __request(OpenAPI, {
      method: 'PUT',
      url: '/api/item-prices/{id}/',
      path: {
   ...
   * @throws ApiError
   */
  public static itemPricesDestroy(id: number): CancelablePromise<void> {
    return __request(OpenAPI, {
      method: 'DELETE',
      url: '/api/item-prices/{id}/',
      path: {
